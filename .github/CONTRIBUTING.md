...
This document describes how you can contribute to preload-tricks. Please read it carefully.
...
## Pull requests
 ...
 ```bash
 git clone git@github.com:YOURNAME/preload-tricks.git
 ```
 ...
 ```bash
 git remote add upstream https://github.com/EasyCoding/preload-tricks.git
 ```
